...
export interface Env {
  CACHE: KVNamespace; USAGE: KVNamespace; UPGRADE_URL: string; GDELT_BASE: string;
  DODO_API_KEY: string;
...
const LLMS_TXT = `# gdelt-events-mcp

> Global news + sentiment via GDELT 2.0.

## Tools
- gdelt_search_events
- gdelt_tone_timeseries
- gdelt_trending_actors
- gdelt_compare (premium)
